    ...
    async fetchPost() {
      try {
        const response = await axios.get(
            `http://election-backend-cmsa.onrender.com/api/forum/topics/${this.$route.params.id}`
        );
    ...
    async submitReply() {
      ...
      try {
        const response = await axios.post(
            `http://election-backend-cmsa.onrender.com/api/forum/topics/${this.$route.params.id}/replies`,
